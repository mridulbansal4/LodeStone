...
/**
 * Mastercard-inspired Landing Page.
 * Built with warm putty-cream canvas (#F3F0EE), floating pill navigation,
 * tight geometric typography (Sofia Sans / MarkForMC style), Ink Black pill CTAs,
 * orbital trajectories in Light Signal Orange (#F37338), and circular portrait
 * cards with docked satellite micro-CTAs.
 */
