...
// The supplied wordmark is a dark-mode asset: the mark and "PARK" are white,
// only "TRACE" is yellow. This header sits on the cream canvas, so it uses the
// ink variant generated by scripts/make-light-logo.mjs. Keep the original for
// any dark surface.
import parkTraceLogo from '../assets/PARKTRACE_LOGO_WITHTEXT_INK.png'
