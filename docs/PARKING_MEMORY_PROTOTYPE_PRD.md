...
| Constant | Value | Note |
|---|---|---|
| `WALK_SPEED` | `3.2 m/s` | Fast enough that 180 m is not tedious **[Assumption]** |
| `SLOW_SPEED` | `1.3 m/s` | Shift held |
...
```js
export const SIM = {
  WALK_SPEED: 3.2, SLOW_SPEED: 1.3, ACCEL: 18, PLAYER_RADIUS: 0.35,
...
| A4 | `WALK_SPEED = 3.2 m/s` — faster than human, keeps the demo brisk | §7.2 |
