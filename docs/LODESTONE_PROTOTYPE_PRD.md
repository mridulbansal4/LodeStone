...
| Constant | Value | Note |
|---|---|---|
| `WALK_SPEED` | `2.2 m/s` | Brisker than a real walk (~1.4) without feeling like a sprint **[Assumption]** |
| `SLOW_SPEED` | `1.0 m/s` | Shift held |
...
```js
export const SIM = {
  WALK_SPEED: 2.2, SLOW_SPEED: 1.0, ACCEL: 18, PLAYER_RADIUS: 0.35,
...
| A4 | `WALK_SPEED = 2.2 m/s` - above walking pace, below a jog | §7.2 |
