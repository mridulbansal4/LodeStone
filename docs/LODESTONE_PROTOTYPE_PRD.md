...
| Constant | Value | Note |
|---|---|---|
| `WALK_SPEED` | `2.1 m/s` | A brisk walk: above a real pace of ~1.4, below a jog **[Assumption]** |
...
```js
export const SIM = {
  WALK_SPEED: 2.1, SLOW_SPEED: 0.8, ACCEL: 18, PLAYER_RADIUS: 0.35,
...
| A4 | `WALK_SPEED = 2.1 m/s` - a brisk walk, tuned by feel | §7.2 |
