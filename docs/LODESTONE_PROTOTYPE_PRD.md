...
| Constant | Value | Note |
|---|---|---|
| `WALK_SPEED` | `2.5 m/s` | Brisk enough to keep the demo moving, short of the 3.2 that read as a jog **[Assumption]** |
...
```js
export const SIM = {
  WALK_SPEED: 2.5, SLOW_SPEED: 0.8, ACCEL: 18, PLAYER_RADIUS: 0.35,
...
| A4 | `WALK_SPEED = 2.5 m/s` - tuned by feel over several passes | §7.2 |
